class Scale
{
    ...
    {
        return new Scale(Intervals.GetIntervals("1,2M,3M,4aug,5,6M,7M"));
    }
    public static Scale GetMajor()
    {
        return new Scale(Intervals.GetIntervals("1,2M,3M,4,5,6M,7M"));
    }
    ...
    {
        return new Scale(Intervals.GetIntervals("1,2m,3m,4,5dim,6m,7m"));
    }
}
